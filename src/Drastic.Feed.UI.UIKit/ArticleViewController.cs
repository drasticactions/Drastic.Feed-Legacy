...
namespace Drastic.Feed.UI.UIKit
{
    public class ArticleViewController : UIViewController
    {
        ...
        private Mac.FeedWebview webview;

        public ArticleViewController()
        {
            this.webview = new Mac.FeedWebview(this.View?.Frame ?? CGRect.Empty, new WebKit.WKWebViewConfiguration());
        ...
        /// </summary>
        public FeedArticleViewModel? FeedArticleVM { get; set; }

        internal Mac.FeedWebview FeedWebview => this.webview;
    }
}