using System;
using Drastic.Feed.UI.Mac;
using Drastic.Feed.UI.ViewModels;

namespace Drastic.Feed.UI.UIKit
{
    public class FeedViewController : UIViewController, IUICollectionViewDelegate
    {
        ...
        public FeedViewController(FeedListViewModel vm)
        {
            this.FeedListVM = vm;
        ...
        /// </summary>
        public FeedListViewModel FeedListVM { get; set; }
