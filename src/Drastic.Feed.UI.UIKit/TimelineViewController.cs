...
namespace Drastic.Feed.UI.UIKit
{
    ...
    {
        public TimelineViewController(FeedItemListViewModel vm)
        {
        ...
        /// </summary>
        public FeedItemListViewModel FeedItemListVM { get; set; }
        ...
        public class TimelineViewSource : UITableViewSource
        {
            ...
            public TimelineViewSource(TimelineViewController controller, IEnumerable<FeedItem> items)
            {
