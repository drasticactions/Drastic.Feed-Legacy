// <copyright file="FeedArticleViewModel.cs" company="Drastic Actions">
...
namespace Drastic.Feed.UI.ViewModels
{
    ...
    /// </summary>
    public class FeedArticleViewModel : BaseViewModel
    {
        private IFeedWebview webview;
        private string html;
        private FeedItem? feedItem;
        private FeedListItem? feedListItem;

        /// <summary>
        /// Initializes a new instance of the <see cref="FeedArticleViewModel"/> class.
        /// </summary>
        /// <param name="webview">Rss Webview.</param>
        /// <param name="services"><see cref="IServiceProvider"/>.</param>
        /// <param name="item">Feed Item.</param>
        public FeedArticleViewModel(IFeedWebview webview, IServiceProvider services, FeedListItem? feedListItem = null, FeedItem? item = null)
            : base(services)
        {
