// <copyright file="FeedItemListViewModel.cs" company="Drastic Actions">
...
namespace Drastic.Feed.UI.ViewModels
{
    ...
    /// </summary>
    public class FeedItemListViewModel : FeedBaseViewModel
    {
        private FeedListItem? feedListItem;

        /// <summary>
        /// Initializes a new instance of the <see cref="FeedItemListViewModel"/> class.
        /// </summary>
        /// <param name="services"><see cref="IServiceProvider"/>.</param>
        public FeedItemListViewModel(IServiceProvider services, FeedListItem? item = null)
            : base(services)
        {
